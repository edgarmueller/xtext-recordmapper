...
* generated by Xtext
*/
package de.emueller.xtext.recordmapper.ui.contentassist.antlr;
...
public class RecordMapperParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.emueller.xtext.recordmapper.ui.contentassist.antlr.internal.InternalRecordMapperParser createParser() {
		de.emueller.xtext.recordmapper.ui.contentassist.antlr.internal.InternalRecordMapperParser result = new de.emueller.xtext.recordmapper.ui.contentassist.antlr.internal.InternalRecordMapperParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRecordMappperFileAccess().getGroup(), "rule__RecordMappperFile__Group__0");
					...
					put(grammarAccess.getRecordMappperFileAccess().getPackageAssignment_1(), "rule__RecordMappperFile__PackageAssignment_1");
					put(grammarAccess.getRecordMappperFileAccess().getImportsAssignment_2(), "rule__RecordMappperFile__ImportsAssignment_2");
					put(grammarAccess.getRecordMappperFileAccess().getDeclarationsAssignment_3(), "rule__RecordMappperFile__DeclarationsAssignment_3");
					put(grammarAccess.getImportAccess().getModelAssignment_1(), "rule__Import__ModelAssignment_1");
					put(grammarAccess.getObjectAccess().getTypeAssignment_0(), "rule__Object__TypeAssignment_0");
					put(grammarAccess.getObjectAccess().getNameAssignment_1(), "rule__Object__NameAssignment_1");
					put(grammarAccess.getObjectAccess().getFieldsAssignment_3(), "rule__Object__FieldsAssignment_3");
					put(grammarAccess.getEnumAccess().getTypeAssignment_0(), "rule__Enum__TypeAssignment_0");
					...
					put(grammarAccess.getFieldAccess().getAnnotationAssignment_2(), "rule__Field__AnnotationAssignment_2");
					put(grammarAccess.getAnnotationAccess().getEntriesAssignment_1(), "rule__Annotation__EntriesAssignment_1");
					...
					put(grammarAccess.getListTypeAccess().getRecordAssignment_0_1(), "rule__ListType__RecordAssignment_0_1");
					put(grammarAccess.getListTypeAccess().getBaseTypeAssignment_1_1(), "rule__ListType__BaseTypeAssignment_1_1");
					put(grammarAccess.getTypeAccess().getDeclAssignment_2(), "rule__Type__DeclAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.emueller.xtext.recordmapper.ui.contentassist.antlr.internal.InternalRecordMapperParser typedParser = (de.emueller.xtext.recordmapper.ui.contentassist.antlr.internal.InternalRecordMapperParser) parser;
			typedParser.entryRuleRecordMappperFile();
