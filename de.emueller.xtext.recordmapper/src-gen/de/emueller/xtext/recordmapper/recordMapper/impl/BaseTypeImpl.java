 ...
 * <ul>
 *   <li>{@link de.emueller.xtext.recordmapper.recordMapper.impl.BaseTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BaseTypeImpl extends TypeImpl implements BaseType
{
  ...
  {
    return RecordMapperPackage.Literals.BASE_TYPE;
  }
  ...
  public void setType(String newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RecordMapperPackage.BASE_TYPE__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RecordMapperPackage.BASE_TYPE__TYPE:
        return getType();
    }
