...
/**
 * Manual modifications go to {de.emueller.xtext.recordmapper.RecordMapperRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractRecordMapperRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "de/emueller/xtext/recordmapper/RecordMapper.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("de.emueller.xtext.recordmapper.RecordMapper");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("cr");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return de.emueller.xtext.recordmapper.services.RecordMapperGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return de.emueller.xtext.recordmapper.serializer.RecordMapperSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return de.emueller.xtext.recordmapper.serializer.RecordMapperSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return de.emueller.xtext.recordmapper.parser.antlr.RecordMapperParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return de.emueller.xtext.recordmapper.parser.antlr.RecordMapperAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return de.emueller.xtext.recordmapper.parser.antlr.internal.InternalRecordMapperLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<de.emueller.xtext.recordmapper.parser.antlr.internal.InternalRecordMapperLexer> provideInternalRecordMapperLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(de.emueller.xtext.recordmapper.parser.antlr.internal.InternalRecordMapperLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(de.emueller.xtext.recordmapper.parser.antlr.internal.InternalRecordMapperLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends de.emueller.xtext.recordmapper.validation.RecordMapperValidator> bindRecordMapperValidator() {
		return de.emueller.xtext.recordmapper.validation.RecordMapperValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return de.emueller.xtext.recordmapper.formatting.RecordMapperFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return de.emueller.xtext.recordmapper.jvmmodel.RecordMapperJvmModelInferrer.class;
	}
