...
public class RecordMapperSyntacticSequencer extends AbstractSyntacticSequencer {

	protected RecordMapperGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (RecordMapperGrammarAccess) access;
